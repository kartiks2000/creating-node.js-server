...
// In the mean while if we excess localhost:3000 our code will execute and we will see the result in the terminal i.e in this case is the 'request' parameter will be primted 